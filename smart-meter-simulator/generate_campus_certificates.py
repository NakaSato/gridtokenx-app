...
class CampusCertificateGenerator:
    ...
    def __init__(self):
        ...
        self.campus_buildings = {
            ...
            "academic": [
                {"id": "AMI_METER_UTCC_ENG_001", "building": "Engineering", "capacity": "50kW/30kWh"},
                {"id": "AMI_METER_UTCC_PHYS_001", "building": "Physics", "capacity": "45kW/25kWh"},
                {"id": "AMI_METER_UTCC_CHEM_001", "building": "Chemistry", "capacity": "40kW/20kWh"},
                {"id": "AMI_METER_UTCC_BIO_001", "building": "Biology", "capacity": "35kW/18kWh"},
                {"id": "AMI_METER_UTCC_MATH_001", "building": "Mathematics", "capacity": "30kW/15kWh"},
                {"id": "AMI_METER_UTCC_CS_001", "building": "Computer Science", "capacity": "55kW/35kWh"},
                {"id": "AMI_METER_UTCC_HIST_001", "building": "History", "capacity": "25kW/12kWh"},
                {"id": "AMI_METER_UTCC_ART_001", "building": "Art", "capacity": "20kW/10kWh"},
            ],
            # Residential Buildings (6 meters)
            "residential": [
                {"id": "AMI_METER_UTCC_DORM_001", "building": "Dormitory West", "capacity": "60kW/40kWh"},
                {"id": "AMI_METER_UTCC_DORM_002", "building": "Dormitory East", "capacity": "55kW/35kWh"},
                {"id": "AMI_METER_UTCC_DORM_003", "building": "Dormitory North", "capacity": "50kW/30kWh"},
                {"id": "AMI_METER_UTCC_GRAD_001", "building": "Graduate Housing", "capacity": "45kW/25kWh"},
                {"id": "AMI_METER_UTCC_FRAT_001", "building": "Fraternity Row", "capacity": "35kW/20kWh"},
                {"id": "AMI_METER_UTCC_APART_001", "building": "Faculty Apartments", "capacity": "40kW/22kWh"},
            ],
            # Administrative Buildings (4 meters)
            "administrative": [
                {"id": "AMI_METER_UTCC_ADMIN_001", "building": "Administration", "capacity": "30kW/15kWh"},
                {"id": "AMI_METER_UTCC_REGIST_001", "building": "Registrar", "capacity": "25kW/12kWh"},
                {"id": "AMI_METER_UTCC_FINANCE_001", "building": "Financial Aid", "capacity": "28kW/14kWh"},
                {"id": "AMI_METER_UTCC_PRES_001", "building": "President Office", "capacity": "32kW/16kWh"},
            ],
            # Athletic & Recreation (3 meters)
            "athletic": [
                {"id": "AMI_METER_UTCC_GYM_001", "building": "Main Gymnasium", "capacity": "80kW/60kWh"},
                {"id": "AMI_METER_UTCC_POOL_001", "building": "Aquatic Center", "capacity": "70kW/50kWh"},
                {"id": "AMI_METER_UTCC_FIELD_001", "building": "Athletic Fields", "capacity": "45kW/30kWh"},
            ],
            # Research Facilities (2 meters)
            "research": [
                {"id": "AMI_METER_UTCC_LAB_001", "building": "Research Laboratory", "capacity": "65kW/45kWh"},
                {"id": "AMI_METER_UTCC_MED_001", "building": "Medical Research", "capacity": "75kW/55kWh"},
            ],
            # Support Services (2 meters)
            "support": [
                {"id": "AMI_METER_UTCC_MAINT_001", "building": "Maintenance", "capacity": "35kW/20kWh"},
                {"id": "AMI_METER_UTCC_DINING_001", "building": "Dining Hall", "capacity": "50kW/30kWh"},
            ]
        }
    ...
    def generate_meter_certificate(self, meter_id: str, building_name: str) -> bool:
        ...
        try:
            ...
            subject = f"/C=TH/ST=Bangkok/L=Bangkok/O=UTCC University/OU=GridTokenX/CN={meter_id}/emailAddress=gridtokenx@utcc.ac.th"
            subprocess.run([
