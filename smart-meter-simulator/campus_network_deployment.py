...
class CampusNetworkManager:
    ...
    def _load_meter_configurations(self) -> List[MeterConfiguration]:
        ...
        campus_buildings = {
            "academic": [
                {"id": "AMI_METER_UTCC_ENG_001", "building": "Engineering", "gen": 50, "storage": 30, "consumption": 40},
                {"id": "AMI_METER_UTCC_PHYS_001", "building": "Physics", "gen": 45, "storage": 25, "consumption": 35},
                {"id": "AMI_METER_UTCC_CHEM_001", "building": "Chemistry", "gen": 40, "storage": 20, "consumption": 32},
                {"id": "AMI_METER_UTCC_BIO_001", "building": "Biology", "gen": 35, "storage": 18, "consumption": 28},
                {"id": "AMI_METER_UTCC_MATH_001", "building": "Mathematics", "gen": 30, "storage": 15, "consumption": 25},
                {"id": "AMI_METER_UTCC_CS_001", "building": "Computer Science", "gen": 55, "storage": 35, "consumption": 45},
                {"id": "AMI_METER_UTCC_HIST_001", "building": "History", "gen": 25, "storage": 12, "consumption": 20},
                {"id": "AMI_METER_UTCC_ART_001", "building": "Art", "gen": 20, "storage": 10, "consumption": 16},
            ],
            "residential": [
                {"id": "AMI_METER_UTCC_DORM_001", "building": "Dormitory West", "gen": 60, "storage": 40, "consumption": 50},
                {"id": "AMI_METER_UTCC_DORM_002", "building": "Dormitory East", "gen": 55, "storage": 35, "consumption": 45},
                {"id": "AMI_METER_UTCC_DORM_003", "building": "Dormitory North", "gen": 50, "storage": 30, "consumption": 40},
                {"id": "AMI_METER_UTCC_GRAD_001", "building": "Graduate Housing", "gen": 45, "storage": 25, "consumption": 38},
                {"id": "AMI_METER_UTCC_FRAT_001", "building": "Fraternity Row", "gen": 35, "storage": 20, "consumption": 30},
                {"id": "AMI_METER_UTCC_APART_001", "building": "Faculty Apartments", "gen": 40, "storage": 22, "consumption": 32},
            ],
            "administrative": [
                {"id": "AMI_METER_UTCC_ADMIN_001", "building": "Administration", "gen": 30, "storage": 15, "consumption": 25},
                {"id": "AMI_METER_UTCC_REGIST_001", "building": "Registrar", "gen": 25, "storage": 12, "consumption": 20},
                {"id": "AMI_METER_UTCC_FINANCE_001", "building": "Financial Aid", "gen": 28, "storage": 14, "consumption": 22},
                {"id": "AMI_METER_UTCC_PRES_001", "building": "President Office", "gen": 32, "storage": 16, "consumption": 26},
            ],
            "athletic": [
                {"id": "AMI_METER_UTCC_GYM_001", "building": "Main Gymnasium", "gen": 80, "storage": 60, "consumption": 70},
                {"id": "AMI_METER_UTCC_POOL_001", "building": "Aquatic Center", "gen": 70, "storage": 50, "consumption": 65},
                {"id": "AMI_METER_UTCC_FIELD_001", "building": "Athletic Fields", "gen": 45, "storage": 30, "consumption": 35},
            ],
            "research": [
                {"id": "AMI_METER_UTCC_LAB_001", "building": "Research Laboratory", "gen": 65, "storage": 45, "consumption": 58},
                {"id": "AMI_METER_UTCC_MED_001", "building": "Medical Research", "gen": 75, "storage": 55, "consumption": 68},
            ],
            "support": [
                {"id": "AMI_METER_UTCC_MAINT_001", "building": "Maintenance", "gen": 35, "storage": 20, "consumption": 28},
                {"id": "AMI_METER_UTCC_DINING_001", "building": "Dining Hall", "gen": 50, "storage": 30, "consumption": 42},
            ]
        }
    ...
    async def start_network(self):
        ...
        logger.info("🏫 Starting UTCC University 25-meter campus network...")
...
async def main():
    ...
    print("🏫 UTCC University GridTokenX Campus Smart Meter Network")
