...
- A basic Gridtokenxapp Solana program written in Anchor
- [codama](https://github.com/codama-idl/codama) to generate a JS sdk for the program
- UI components for interacting with the Gridtokenxapp program using the Anchor generated client
...
```shell
npx create-solana-dapp@latest -t gh:solana-foundation/templates/gill/gridtokenx-app
```
...
the constant in the `anchor/src/gridtokenxapp-exports.ts` file.
